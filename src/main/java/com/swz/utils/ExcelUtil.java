...
import com.swz.exception.ExcelException;
import jxl.Cell;
import jxl.Workbook;
...
//            }
     ...
     * @method: getFieldValueByNameSequence
    ...
    public static void main(String[] args) throws Exception {
        String excName = "E:\\ccicall\\data\\excel\\test.xls";
        File file = new File(excName);
        FileOutputStream fos = new FileOutputStream(file);
        PersonDO personDO1 =new PersonDO();
        personDO1.setName("swz");
        personDO1.setAge(20);
        ...
        fieldMap.put("age", "年龄");
        ExcelUtil.listToExcel(list, fieldMap, excName, fos);
    }
}
